      ...
      then do putStrLn "ERR"
              ...
              if  input1_cmd == "NTH" && length input1_sep == 2
                       then do  let input1_para = last input1_sep
                                if  all isDigit input1_para && (read input1_para :: Int) >= 0 && (length input1_para) + (length input1_cmd) == (length input1) - 1
                                ...
                                then do
                                     ...
                                     if  all isDigit input1_para && (read input1_para :: Int) >= 0 && (length input1_para) + (length input1_cmd) == (length input1) - 1
                                         ...
                                         then do let input1_para = last input1_sep
                                                 if (length input1_para) + (length input1_cmd) == (length input1) - 1
                                                    then do
                                         ...
                                         else if  input1_cmd == "QUIT" && length input1_cmd == length input1
                                                  then do return()
                                                  else do  putStrLn"ERR"
